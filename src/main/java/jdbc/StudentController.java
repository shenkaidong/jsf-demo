...
public class StudentController {
	...
	public String downloadStudents() {
		...
		try {
			...
			// get all students from database
			students = studentDbUtil.getStudents();
			FileWriter myWriter = new FileWriter("/student-tracker-advanced/filename.txt");
		      myWriter.write(students.toString());
		      myWriter.close();	     
			
		} catch (Exception exc) {
			// send this to server logs
			logger.log(Level.SEVERE, "Error download students", exc);
	...
	public String addStudent(StudentInfo theStudent) {

		System.out.println("addStudent in Controller was run");
	...
	public String loadStudent(int studentId) {
		...
		try {
			...
			StudentInfo theStudent = studentDbUtil.getStudent(studentId);
			
			// put in the request attribute ... so we can use it on the form page
			ExternalContext externalContext = FacesContext.getCurrentInstance().getExternalContext();		
			
			Map<String, Object> requestMap = externalContext.getRequestMap();
			requestMap.put("studentInfo", theStudent);	
	...
	public String updateStudent(StudentInfo theStudent) {
